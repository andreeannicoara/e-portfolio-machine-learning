...
function initSearch() {
  ...
  request.open('GET', '/e-portfolio-machine-learning/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/e-portfolio-machine-learning/assets/css/just-the-docs-' + theme + '.css');
}
